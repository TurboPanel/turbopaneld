...
| Container `turbopanela` / volume `turbopanela` on network `turbopanel` | Running server + persistent MergeTree data (in-container `/var/lib/clickhouse`) |
