# ClickHouse (self-hosted analytics) — AGENTS.md
...
Root context: `../AGENTS.md`. Instance-side ClickHouse metrics store + schema/query contract: `../../instance/src/daemon/metrics/AGENTS.md`. Cross-repo `../<repo>/…` links are relative to the repo root.
