...
const PRESENTER_ORCHESTRATION_DROP_PATTERNS: readonly RegExp[] = [
  ...
  /^installing galaxy (?:roles|collections|docker role) from /i,
  /^installing orchestration (?:roles|collections|docker role) from /i,
  /^ansible already installed/i,
  /^orchestration already installed/i,
  /^galaxy content up to date/i,
  /^galaxy docker role up to date/i,
  /^orchestration content up to date/i,
  /^orchestration docker role up to date/i,
  ...
  /^galaxy (?:roles|collections|docker role) ready$/i,
  /^orchestration (?:roles|collections|docker role) ready$/i,
