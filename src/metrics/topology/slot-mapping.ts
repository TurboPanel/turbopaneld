 ...
 * first slot. Everything else follows sorted by id. Pinning by role is what
 * keeps the filesystems a storage panel renders (root, hosting, Docker,
